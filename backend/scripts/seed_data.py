...
VENDORS = [
    ...
    dict(name="Alpha Industrial Works", contact_name="Test QA", email="qa+alpha@vendorclear.ai",
         ...
         assigned_analyst_id="__ANALYST_1__"),
    # ── Transportation ───────────────────────────────────────
    dict(name="Ridgeline Hauling & Logistics", contact_name="Denise Ford", email="denise@ridgelinehaul.com",
         phone="214-555-0177", city="Fort Worth", state="TX", zip_code="76102",
         status=VendorStatus.COMPLIANT, risk_tier=RiskTier.LOW,
         gl_expiry=d(150), wc_expiry=d(160), diversity_types=["DBE"],
         notes="Fleet vendor for grid equipment transport between depots.",
         category=VendorCategory.TRANSPORTATION, vendor_type=VendorType.SUPPLIER,
         business_unit="Logistics", region="Southwest", insurance_provider="Progressive Commercial",
         assigned_analyst_id="__ANALYST_1__"),
    dict(name="Summit Freight Partners", contact_name="Oscar Nguyen", email="oscar@summitfreight.com",
         phone="817-555-0193", city="Dallas", state="TX", zip_code="75201",
         status=VendorStatus.NEEDS_REVIEW, risk_tier=RiskTier.MEDIUM,
         gl_expiry=d(21), wc_expiry=d(45), diversity_types=None,
         notes="Auto liability certificate pending re-verification.",
         category=VendorCategory.TRANSPORTATION, vendor_type=VendorType.SUPPLIER,
         business_unit="Logistics", region="Southwest", insurance_provider="Old Republic",
         assigned_analyst_id="__ANALYST_2__"),
    # ── Civil ─────────────────────────────────────────────────
    dict(name="Bedrock Civil & Site Works", contact_name="Marisol Vega", email="marisol@bedrockcivil.com",
         phone="512-555-0166", city="Austin", state="TX", zip_code="78745",
         status=VendorStatus.COMPLIANT, risk_tier=RiskTier.LOW,
         gl_expiry=d(200), wc_expiry=d(210), diversity_types=["WBE", "MBE"],
         notes="Site grading and civil works for substation expansions.",
         category=VendorCategory.CIVIL, vendor_type=VendorType.SUBCONTRACTOR,
         business_unit="Field Operations", region="Southwest", insurance_provider="Travelers",
         assigned_analyst_id="__ANALYST_1__"),
    dict(name="Ironclad Civil Contractors", contact_name="Terrence Boyd", email="terrence@ironcladcivil.com",
         phone="210-555-0184", city="San Antonio", state="TX", zip_code="78201",
         status=VendorStatus.NON_COMPLIANT, risk_tier=RiskTier.HIGH,
         gl_expiry="2026-06-01", wc_expiry="2026-05-20", diversity_types=None,
         notes="Workers comp certificate expired, awaiting renewal upload.",
         category=VendorCategory.CIVIL, vendor_type=VendorType.SUBCONTRACTOR,
         business_unit="Field Operations", region="Southwest", insurance_provider="Nationwide",
         assigned_analyst_id="__ANALYST_2__"),
]
